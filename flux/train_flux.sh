...
# Train the committed FLUX adapter implementation on several categories.
# The sexual run can be enabled in the same form when needed.

# CUDA_VISIBLE_DEVICES=1 python flux/train_flux.py \
